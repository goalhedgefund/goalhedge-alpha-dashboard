...
function usage() {
  return `
Usage:
  node scripts/futures-bulk-download.js --symbol RELIANCE
  node scripts/futures-bulk-download.js --symbols RELIANCE,SBIN,TCS --days 5
  node scripts/futures-bulk-download.js --file D:\\CODEX\\data\\my-symbols.csv --resume-from-cache
  node scripts/futures-bulk-download.js --universe FUTSTK --resume-from-cache
  node scripts/futures-bulk-download.js --all --resume-from-cache

Options:
  --symbol RELIANCE              Download one cash symbol.
  ...
  --days 5                       Lookback calendar days. Default: 5.
